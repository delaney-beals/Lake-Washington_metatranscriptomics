...
Given 3 biological replicates, each with a corresponding metagenome (21142X#) and metatranscriptome (21113X#), here are the avenues for analysis: 
1. [Mapping merged reads to the co-assembly](https://github.com/delaney-beals/LW-lowFe/blob/main/Co-assembly_README.md)
